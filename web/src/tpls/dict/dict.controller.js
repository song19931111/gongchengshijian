/**
 * Created by xiangsong on 2017/4/8.
 */
/**
...
(function () {
    ...
    angular.module('mainApp')
        .controller('dictCtrl',['$scope','dictAjaxService','$uibModal','$state' ,function ($scope,dictAjaxService,$uibModal,$state) {
            var GetAllUser = function () {
                ...
                //获取所有的用户
                dictAjaxService.getList($scope.currentPage).then(function (result) {
                    console.log(result);
